...
class Database(object):
    ...
    def __init__(self):
        ...
        self.replicaServers = {'R1': R1, 'R3': R3}
    ...
    def initConnect(self, name):
        if name in self.clients:
            ...
            return '\nHi {0}, We currently do not have you as an existing customer. We have added your name to the database.'.format(
                name)
    ...
    def postUpdate(self):
        ...
        for server in self.replicaServers:
            try:
                response = self.replicaServers[server].recieveUpdate('R2')
...
print("Server R2 Online: Object uri = {0}\n".format(uri))
