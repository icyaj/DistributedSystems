# Webservice 2 - 'http://api.getthedata.com/postcode'
...
class WebService(object):
    ...
    def __init__(self):
        self.url = 'http://api.getthedata.com/postcode'

    # Returns the address of the Postcode in the form longitude & latitude.
    def getAddress(self, postcode):
        ...
        try:
            ...
            if (js['status'] != 'match') or (js == []):
                return 404, 'Error - POSTCODE Not Found. Webservice 2 - http://api.getthedata.com/postcode'
            else:
                return 200, {'longitude': js['data']['longitude'], 'latitude': js['data']['latitude']}

        except urllib.request.HTTPError as e:
            return 404, 'Error - POSTCODE Not Found. Webservice 2 - http://api.getthedata.com/postcode'

        except OSError:
            return 503, 'Error - API {0} Failed To Connect. Webservice 2 - http://api.getthedata.com/postcode'.format(self.url)
...
print("Server WS2 Online: Object uri =", uri)
